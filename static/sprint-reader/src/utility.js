...
function getLanguage(selectedText){
	...
	// load the pattern script  ../lib/guess_language/language_patterns/
	var patternJS = '/static/sprint-reader/lib/guess_language/language_patterns/' + language.pattern + '.js'
	$.ajax({
		async: false,
	  	url: patternJS,
	  	dataType: "script"
